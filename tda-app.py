...
translations = {
    "EN 🇬🇧": {
        ...
        "goal-text": "We wish to distinguish between data sets by identifying their shapes. Important aspects of these shapes are connected components (blue dots and bars 🔵) or holes (orange dots and bars 🟠).",
    ...
    "DE 🇩🇪": {
        ...
        "goal-text": "Wir wollen Datensätze unterscheiden können, indem wir ihre Formen ausfindig machen. Wichtige Aspekte dieser Formen sind Zusammenhangskomponenten (blaue Punkte und Balken 🔵) oder Löcher (orange Punkte und Balken 🟠).",
